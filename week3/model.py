...
def Deeplabv3(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=21, backbone='mobilenetv2', OS=16, alpha=1.):
    ...
    x = Lambda(lambda x: tf.transpose(x, [0,2,1,3]))(img_input)
    ...
    x = Activation('softmax', name="fcfOutput")(x)
    # ---------------------------------------------- END  --------------------------------------------------- #
    ...
    if weights == 'pascal_voc':
        if backbone == 'xception':
            weights_path = 'pretrained/deeplabv3_xception_tf_dim_ordering_tf_kernels.h5'
#            weights_path = get_file('deeplabv3_xception_tf_dim_ordering_tf_kernels.h5',
#                                    WEIGHTS_PATH_X,
 #                                 cache_subdir='models')
        else:
            weights_path = 'pretrained/deeplabv3_mobilenetv2_tf_dim_ordering_tf_kernels.h5'
